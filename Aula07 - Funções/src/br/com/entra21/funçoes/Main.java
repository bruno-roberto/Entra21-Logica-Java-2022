package br.com.entra21.funçoes;
...
public class Main {
	...
	public static void verProcedimentos() {
		...
		// chamada de fun��o onde eu passo os argumento caso precise
		capturarFrase();
	...
	public static void verParametros(int numero) {// o valor informado cai nessa variavel temporaria
		...
		if (numero % 2 == 0) {
			System.out.println("Que legal e esse numero ainda � par...");
		}
	}
	...
	public static void verMaisParametros(String escolha, String nome, int numero) {
		...
		if (numero < 100) {
			...
			System.out.println("� maior ou igual a 100");
		}
	}
